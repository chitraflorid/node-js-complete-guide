 ...
 * demonstrates the use of partials in the EJS templating      *
 * engine. Though EJS does not provide layout capabilities     *
 * as is the case with the Pug and Handlebars engines, it      *
 * does provide partials, which have much of the same          *
 * functionality found in layouts.                             *
 *                                                             *
 ***************************************************************
*/
